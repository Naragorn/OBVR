...
// origin and the distance to it, at least minUnits (the caller passes none:
// a floor made the object flicker near the body, 2026-09-26). The hand's line from the HMD with
