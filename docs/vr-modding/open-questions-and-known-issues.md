...
| The visible body unconfirmed | `[Body] Visible=1` may show nothing, a body in the wrong place, a face in front of the eyes, or a headless inventory paperdoll | look down in first person; open the inventory | `PlayerBody.cpp`, `BodyPlacement.h` | built 2026-09-07, tests green, no headset run | `Visible=0` | unknown until seen | built, confirmation open |
